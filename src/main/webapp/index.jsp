...
<div class="wrapper">
    ...
    <ul class="foodtype">
        <li onclick="location.href='businessList?orderTypeId=1'">
            <img src="img/c6213db2a0bbc6b7342074e9eb51ca4a12844.webp" alt="美食">
            <p>美食</p>
        </li>
        <li onclick="location.href='businessList?orderTypeId=1'">
            <img src="img/lunch.webp" alt="精品午餐">
            <p>精品午餐</p>
        </li>
        <li onclick="location.href='businessList?orderTypeTd=1'">
            <img src="img/家常菜.png" alt="家常菜">
            <p>家常菜</p>
        </li>
        <li onclick="location.href='businessList?orderTypeId=1'">
            <img src="img/小吃馆.webp" alt="小吃馆">
            <p>小吃馆</p>
        </li>
        <li onclick="location.href='businessList?orderTypeId=1'">
            <img src="img/超市便利.webp" alt="超市便利">
            <p>商超便利</p>
        </li>
        <li onclick="location.href='businessList?orderTypeId=1'">
            <img src="img/甜点饮品.webp" alt="甜点饮品">
            <p>甜品饮品</p>
        </li>
        <li onclick="location.href='businessList?orderTypeId=1'">
            <img src="img/异国料理.png" alt="异国料理">
            <p>异国料理</p>
        </li>
        <li onclick="location.href='businessList?orderTypeId=1'">
            <img src="img/鲜花蛋糕.webp" alt="鲜花蛋糕">
            <p>鲜花蛋糕</p>
        </li>
    </ul>
    <div class="banner" onclick="location.href='businessInfo?userId=1&businessId=1'">
        <h3>品质套餐</h3>
        <p>搭配齐全吃得好</p>
        <a href="#">立即购买 &gt;</a>
    </div>
        ...
        <li  onclick="location.href='businessInfo?userId=1&businessId=<%=business.getBusinessId()%>'">
            ...
            <div class="business-info">
                ...
                <div class="business-info-explain">
                    <div><%=business.getBusinessExplain()%></div>
                </div>
